          ...
          {isSuccess ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 px-4 py-2.5 border border-brand-border rounded-xl text-xs font-bold text-brand-navy bg-white hover:bg-brand-white transition-colors duration-200"
                  disabled={isSubmitting}
                >
