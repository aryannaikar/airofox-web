  ...
  return (
    <>
      <header style={{
        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '0 16px', height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <nav className="hidden md:flex items-center gap-8">
            {NAV.map(l => (
              <Link key={l.name} to={l.path} style={{
                ...
                color: location.pathname === l.path ? '#ff7a00' : '#334155',
